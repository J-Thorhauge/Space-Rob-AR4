...
#include "gorm_arm_driver/arduino_nano_driver.hpp"

using namespace hardware_interface;

namespace gorm_arm_driver
{
    class GormArmGripperHWInterface : public hardware_interface::SystemInterface
    {
    public:
        RCLCPP_SHARED_PTR_DEFINITIONS(GormArmGripperHWInterface);
    ...
    private:
        rclcpp::Logger logger_ = rclcpp::get_logger("gorm_arm_gripper_hw_interface");
