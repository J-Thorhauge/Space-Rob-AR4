...
#include "gorm_arm_driver/teensy_driver.hpp"

using namespace hardware_interface;

namespace gorm_arm_driver
{
    class GormArmHardwareInterface : public hardware_interface::SystemInterface
    {
    public:
        RCLCPP_SHARED_PTR_DEFINITIONS(GormArmHardwareInterface);
    ...
    private:
        rclcpp::Logger logger_ = rclcpp::get_logger("gorm_arm_driver");
