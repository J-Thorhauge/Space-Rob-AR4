#include <gorm_arm_driver/gorm_arm_gripper_hw_interface.hpp>
#include <sstream>

namespace gorm_arm_driver
{

  hardware_interface::CallbackReturn GormArmGripperHWInterface::on_init(
  ...
  hardware_interface::CallbackReturn GormArmGripperHWInterface::on_activate(
  ...
  hardware_interface::CallbackReturn GormArmGripperHWInterface::on_deactivate(
      const rclcpp_lifecycle::State & /*previous_state*/)
  {
  ...
  GormArmGripperHWInterface::export_state_interfaces()
  {
  ...
  GormArmGripperHWInterface::export_command_interfaces()
  {
  ...
  hardware_interface::return_type GormArmGripperHWInterface::read(
  ...
  hardware_interface::return_type GormArmGripperHWInterface::write(
      const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
  {
...
PLUGINLIB_EXPORT_CLASS(gorm_arm_driver::GormArmGripperHWInterface,
